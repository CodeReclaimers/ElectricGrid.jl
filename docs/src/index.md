...
- Train RL agents as controllers with the built-in DDPG/TD3 implementations or write your own ones. The environment and agent interface follows the design of ReinforcementLearning.jl v0.10, which ElectricGrid now bundles internally instead of depending on it
